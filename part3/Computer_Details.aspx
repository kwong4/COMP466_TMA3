...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2>
        ...
        <div class="auto-style3">
                <p><strong>OS:</strong>
                    <asp:DropDownList ID="OSDropDownList" runat="server" OnSelectedIndexChanged="SelectedIndexChanged" AutoPostBack="True">
                ...
                <p><strong>CPU:</strong> 
                    <asp:DropDownList ID="CPUDropDownList" runat="server" OnSelectedIndexChanged="SelectedIndexChanged" AutoPostBack="True">
                ...
                <p><strong>RAM:</strong>
                    <asp:DropDownList ID="RAMDropDownList" runat="server" OnSelectedIndexChanged="SelectedIndexChanged" AutoPostBack="True">
                ...
                <p><strong>HARD DRIVE:</strong> 
                    <asp:DropDownList ID="HardDriveDropDownList" runat="server" OnSelectedIndexChanged="SelectedIndexChanged" AutoPostBack="True">
                ...
                <p><strong>DISPLAY:</strong> 
                    <asp:DropDownList ID="DisplayDropDownList" runat="server" OnSelectedIndexChanged="SelectedIndexChanged" AutoPostBack="True">
                ...
                <p><strong>SOUND CARD:</strong> 
                    <asp:DropDownList ID="SoundCardDropDownList" runat="server" OnSelectedIndexChanged="SelectedIndexChanged" AutoPostBack="True">
